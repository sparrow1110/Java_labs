...
public class Main {
    ...
    public static ArrayList<Long> controllerComponentList(int n) throws IOException {
        return CollectionTester.testArrayListOperations(n);
    }

    public static ArrayList<Long> controllerComponentLinkedList(int n) throws IOException {
        return CollectionTester.testLinkedListOperations(n);
    }
    /**
